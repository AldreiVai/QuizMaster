...
public class ComputerEasyQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_easy_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllComputerEasyQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(ComputerEasyQuiz.this, ComputerScore.class);
        String quiz = "computer_easy";
