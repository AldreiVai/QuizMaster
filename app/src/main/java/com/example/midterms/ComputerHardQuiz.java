...
public class ComputerHardQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_hard_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllComputerHardQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(ComputerHardQuiz.this, ComputerScore.class);
        String quiz = "computer_hard";
