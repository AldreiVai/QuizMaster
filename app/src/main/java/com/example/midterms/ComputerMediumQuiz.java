...
public class ComputerMediumQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_medium_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllComputerMediumQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(ComputerMediumQuiz.this, ComputerScore.class);
        String quiz = "computer_medium";
