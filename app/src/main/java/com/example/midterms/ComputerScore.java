...
public class ComputerScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_score);
        ...
        if (quiz != null) {
            if (quiz.equals("computer_easy")) {
                previousScore = databaseHelper.getComputerEasyScore(username);
            } else if (quiz.equals("computer_easy_medium")) {
                previousScore = databaseHelper.getComputerMediumScore(username);
            } else if (quiz.equals("computer_hard")) {
                previousScore = databaseHelper.getComputerHardScore(username);
            }
        }
        ...
        if (currentScore > previousScore) {
            if (quiz != null) {
                if (quiz.equals("computer_easy")) {
                    databaseHelper.updateComputerEasyScore(username, currentScore);
                } else if (quiz.equals("computer_medium")) {
                    databaseHelper.updateComputerMediumScore(username, currentScore);
                } else if (quiz.equals("computer_hard")) {
                    databaseHelper.updateComputerHardScore(username, currentScore);
                }
            }
        ...
        buttonTryAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (quiz != null) {
                    if (quiz.equals("computer_easy")) {
                        Intent tryAgain = new Intent(ComputerScore.this, ComputerEasyQuiz.class);
                        startActivity(tryAgain);
                    } else if (quiz.equals("computer_medium")) {
                        Intent tryAgain = new Intent(ComputerScore.this, ComputerMediumQuiz.class);
                        startActivity(tryAgain);
                    } else if (quiz.equals("computer_hard")) {
                        Intent tryAgain = new Intent(ComputerScore.this, ComputerHardQuiz.class);
                        startActivity(tryAgain);
                    }
                }
            }
        ...
        buttonHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                home = new Intent(ComputerScore.this, Home.class);
