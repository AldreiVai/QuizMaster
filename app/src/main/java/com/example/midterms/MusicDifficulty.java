...
public class MusicDifficulty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_difficulty);
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MusicDifficulty.this, Home.class);
        ...
        btnEasy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent easyintent = new Intent(MusicDifficulty.this, MusicEasyQuiz.class);
        ...
        btnMedium.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mediumintent = new Intent(MusicDifficulty.this, MusicMediumQuiz.class);
        ...
        btnHard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hardintent = new Intent(MusicDifficulty.this, MusicHardQuiz.class);
