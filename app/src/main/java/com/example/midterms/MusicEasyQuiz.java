...
public class MusicEasyQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_easy_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllMusicEasyQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(MusicEasyQuiz.this, MusicScore.class);
        String quiz = "music_easy";
