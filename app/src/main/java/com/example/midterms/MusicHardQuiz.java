...
public class MusicHardQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_hard_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllMusicHardQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(MusicHardQuiz.this, MusicScore.class);
        String quiz = "music_hard";
