...
public class MusicMediumQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_medium_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllMusicMediumQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(MusicMediumQuiz.this, MusicScore.class);
        String quiz = "music_medium";
