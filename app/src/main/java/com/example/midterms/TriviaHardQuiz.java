...
public class TriviaHardQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trivia_hard_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllTriviaHardQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(TriviaHardQuiz.this, TriviaScore.class);
        String quiz = "trivia_hard";
