...
public class TriviaMediumQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trivia_medium_quiz);
    ...
    private List<Question> getQuestions() {
        ...
        List<Question> questions = dbHelper.getAllTriviaMediumQuestions();
    ...
    private void endQuiz() {
        ...
        Intent intent = new Intent(TriviaMediumQuiz.this, TriviaScore.class);
        String quiz = "trivia_medium";
